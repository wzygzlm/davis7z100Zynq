...
architecture STRUCTURE of davisZynqBasicBoard_ulpi_wrapper_0_0_ulpi_wrapper is
  ...
  signal \tx_buffer_q[0][7]_i_2_n_0\ : STD_LOGIC;
  ...
  signal ulpi_stp_q11_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \data_q[1]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \data_q[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \data_q[3]_i_1\ : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of mode_complete_o_INST_0 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \state_q[0]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \state_q[1]_i_2\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of tx_delay_complete_o_INST_0 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \tx_delay_q[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \tx_delay_q[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \tx_delay_q[2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \tx_valid_q[0]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of tx_wr_idx_q_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \ulpi_data_q[3]_rep_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \ulpi_data_q[3]_rep_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \ulpi_data_q[3]_rep_i_5\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ulpi_data_q[4]_rep_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ulpi_data_q[5]_rep_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \ulpi_data_q[6]_rep_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \ulpi_data_q[7]_rep_i_3\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of ulpi_stp_q_i_1 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of ulpi_stp_q_i_2 : label is "soft_lutpair6";
  attribute IOB of ulpi_stp_q_reg : label is "TRUE";
  attribute SOFT_HLUTNM of utmi_rxactive_q_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of utmi_tx_accept_o_INST_0_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of utmi_tx_accept_o_INST_0_i_2 : label is "soft_lutpair1";
...
mode_write_q_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"02FF0200"
    )
        port map (
...
mode_write_q_i_2: unisim.vcomponents.LUT6
    generic map(
...
\tx_buffer_q[0][7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\ulpi_data_q[0]_rep_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"00E2"
    )
        port map (
...
\ulpi_data_q[1]_rep_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"40444040"
    )
        port map (
...
\ulpi_data_q[1]_rep_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BABBBAAA"
    )
        port map (
...
\ulpi_data_q[3]_rep_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"40404440"
    )
        port map (
...
\ulpi_data_q[3]_rep_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BABBBAAA"
    )
        port map (
...
\ulpi_data_q[4]_rep_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
\ulpi_data_q[5]_rep_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
\ulpi_data_q[6]_rep_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
ulpi_stp_q_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"888FFF8F"
    )
        port map (
...
utmi_rxactive_q_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AF08"
    )
        port map (
...
begin
  ...
  utmi_linestate_o(1) <= \<const0>\;
  utmi_linestate_o(0) <= \<const0>\;
  utmi_rxerror_o <= \<const0>\;
