...
################################################################
# This is a generated script based on design: bd_0a05
#
...
proc create_root_design { parentCell } {
  ...
  set probe22 [ create_bd_port -dir I -from 7 -to 0 probe22 ]
  set probe23 [ create_bd_port -dir I -from 1 -to 0 probe23 ]
  set probe24 [ create_bd_port -dir I -from 0 -to 0 probe24 ]
  set probe25 [ create_bd_port -dir I -from 1 -to 0 probe25 ]
  ...
  set probe29 [ create_bd_port -dir I -from 19 -to 0 probe29 ]
