...
################################################################
# This is a generated script based on design: bd_cac4
#
...
proc create_root_design { parentCell } {
  ...
  set probe41 [ create_bd_port -dir I -from 6 -to 0 probe41 ]
  set probe42 [ create_bd_port -dir I -from 0 -to 0 probe42 ]
  set probe43 [ create_bd_port -dir I -from 3 -to 0 probe43 ]
  set probe44 [ create_bd_port -dir I -from 0 -to 0 probe44 ]
  set probe45 [ create_bd_port -dir I -from 0 -to 0 probe45 ]
  set probe46 [ create_bd_port -dir I -from 6 -to 0 probe46 ]
  set probe47 [ create_bd_port -dir I -from 31 -to 0 probe47 ]
  set probe48 [ create_bd_port -dir I -from 3 -to 0 probe48 ]
  set probe49 [ create_bd_port -dir I -from 0 -to 0 probe49 ]
  set probe50 [ create_bd_port -dir I -from 6 -to 0 probe50 ]
  ...
  set probe55 [ create_bd_port -dir I -from 7 -to 0 probe55 ]
  set probe56 [ create_bd_port -dir I -from 7 -to 0 probe56 ]
  set probe57 [ create_bd_port -dir I -from 0 -to 0 probe57 ]
  set probe58 [ create_bd_port -dir I -from 7 -to 0 probe58 ]
  set probe59 [ create_bd_port -dir I -from 63 -to 0 probe59 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ILA_CLK_FREQ {58817650} \
