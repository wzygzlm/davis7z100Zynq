...
module davisZynqBasicBoard_usb_cdc_core_0_0(clk_i, rst_i, enable_i, utmi_data_in_i, 
  ...
  inport_valid_i, inport_data_i, outport_accept_i, token_valid_w_do, token_dev_w_do, 
  ...
  wValue_w_do, usb_reset_w_do, usb_reset_counter_q_do, debug_counter_q_do, 
  current_token_debug_counter_q_do, token_valid_counter_q_do, utmi_data_out_o, 
