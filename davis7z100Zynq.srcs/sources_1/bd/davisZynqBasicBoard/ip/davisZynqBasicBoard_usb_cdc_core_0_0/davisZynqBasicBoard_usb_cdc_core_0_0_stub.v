...
module davisZynqBasicBoard_usb_cdc_core_0_0(clk_i, rst_i, enable_i, utmi_data_in_i, 
  ...
  state_q_rx_do, shift_en_w_do, data_buffer_q_do, data_ready_w_do, crc_byte_w_do, 
  rx_active_w_do, token_dev_q_do, token_ep_q_do, current_addr_i_do, ctrl_sending_r_do, 
  ctrl_send_accept_w_do, desc_addr_q_do, setup_valid_q_do, setup_frame_q_do, rx_last_w_do, 
  bmRequestType_w_do, bRequest_w_do, usb_reset_w_do, usb_reset_counter_q_do, 
  debug_counter_q_do, utmi_data_out_o, utmi_txvalid_o, utmi_op_mode_o, utmi_xcvrselect_o, 
  utmi_termselect_o, utmi_dppulldown_o, utmi_dmpulldown_o, inport_accept_o, 
  outport_valid_o, outport_data_o)
/* synthesis syn_black_box black_box_pad_pin="clk_i,rst_i,enable_i,utmi_data_in_i[7:0],utmi_txready_i,utmi_rxvalid_i,utmi_rxactive_i,utmi_rxerror_i,utmi_linestate_i[1:0],inport_valid_i,inport_data_i[7:0],outport_accept_i,state_r_do[2:0],usb_rst_time_do[31:0],state_q_rx_do[3:0],shift_en_w_do,data_buffer_q_do[31:0],data_ready_w_do,crc_byte_w_do,rx_active_w_do,token_dev_q_do[6:0],token_ep_q_do[3:0],current_addr_i_do[6:0],ctrl_sending_r_do,ctrl_send_accept_w_do,desc_addr_q_do[6:0],setup_valid_q_do,setup_frame_q_do,rx_last_w_do,bmRequestType_w_do[7:0],bRequest_w_do[7:0],usb_reset_w_do,usb_reset_counter_q_do[7:0],debug_counter_q_do[63:0],utmi_data_out_o[7:0],utmi_txvalid_o,utmi_op_mode_o[1:0],utmi_xcvrselect_o[1:0],utmi_termselect_o,utmi_dppulldown_o,utmi_dmpulldown_o,inport_accept_o,outport_valid_o,outport_data_o[7:0]" */;
  input clk_i;
  input rst_i;
  input enable_i;
