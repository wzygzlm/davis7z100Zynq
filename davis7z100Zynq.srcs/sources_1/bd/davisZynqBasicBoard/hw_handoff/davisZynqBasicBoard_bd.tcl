...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {58.968464} \
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {0.193144} \
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_I2C_PERIPHERAL_FREQMHZ {50} \
   CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {191.647507} \
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {95.823753} \
   CONFIG.PCW_ACT_SMC_PERIPHERAL_FREQMHZ {95.823753} \
   ...
   CONFIG.PCW_ACT_UART_PERIPHERAL_FREQMHZ {95.823753} \
   ...
   CONFIG.PCW_CLK0_FREQ {58968464} \
   CONFIG.PCW_CLK1_FREQ {10000000} \
   CONFIG.PCW_CLK2_FREQ {193144} \
   ...
   CONFIG.PCW_FCLK2_PERIPHERAL_DIVISOR0 {63} \
   CONFIG.PCW_FCLK2_PERIPHERAL_DIVISOR1 {63} \
   ...
   CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {0.1} \
   ...
   CONFIG.PCW_IOPLL_CTRL_FBDIV {23} \
   CONFIG.PCW_IO_IO_PLL_FREQMHZ {766.590} \
   ...
   CONFIG.PCW_SMC_PERIPHERAL_DIVISOR0 {8} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins blk_mem_gen_0/addrb] [get_bd_pins c_counter_binary_0/Q] [get_bd_pins system_ila_0/probe51]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets c_counter_binary_0_Q]
  connect_bd_net -net c_counter_binary_1_Q [get_bd_pins c_counter_binary_1/Q] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net const_HIGH_dout [get_bd_pins axis_data_fifo_0/s_axis_tvalid] [get_bd_pins blk_mem_gen_0/enb] [get_bd_pins const_HIGH/dout] [get_bd_pins usb_cdc_core_0/enable_i] [get_bd_pins usb_cdc_core_0/outport_accept_i]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins LEDShifter_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_9M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins ulpi_wrapper_0/ulpi_clk60_i] [get_bd_pins ulpi_wrapper_1/ulpi_clk60_i] [get_bd_pins usb_cdc_core_0/clk_i]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins c_counter_binary_1/CLK] [get_bd_pins processing_system7_0/FCLK_CLK2]
  ...
  connect_bd_net -net rst_ps7_0_9M_peripheral_aresetn [get_bd_pins LEDShifter_0/rstn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_9M/peripheral_aresetn]
  connect_bd_net -net rst_ps7_0_9M_peripheral_reset [get_bd_pins c_counter_binary_0/SCLR] [get_bd_pins c_counter_binary_1/SCLR] [get_bd_pins usb_cdc_core_0/rst_i] [get_bd_pins xlslice_0/Dout]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net state_r_do [get_bd_pins system_ila_0/probe39] [get_bd_pins usb_cdc_core_0/state_r_do] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlconcat_0/In1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net ulpi_wrapper_0_utmi_data_in_o [get_bd_pins system_ila_0/probe8] [get_bd_pins ulpi_wrapper_0/utmi_data_in_o] [get_bd_pins usb_cdc_core_0/utmi_data_in_i] [get_bd_pins xlconcat_1/In0]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net ulpi_wrapper_0_utmi_rxvalid_o [get_bd_pins c_counter_binary_0/CE] [get_bd_pins system_ila_0/probe34] [get_bd_pins ulpi_wrapper_0/utmi_rxvalid_o] [get_bd_pins usb_cdc_core_0/utmi_rxvalid_i] [get_bd_pins util_vector_logic_2/Op2]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins system_ila_0/probe52] [get_bd_pins util_reduced_logic_0/Res] [get_bd_pins util_vector_logic_2/Op1]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_nets util_vector_logic_1_Res]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_pins util_vector_logic_2/Res] [get_bd_pins xlconcat_2/In0] [get_bd_pins xlconcat_2/In1] [get_bd_pins xlconcat_2/In2] [get_bd_pins xlconcat_2/In3]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins blk_mem_gen_0/dinb] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins blk_mem_gen_0/web] [get_bd_pins xlconcat_2/dout]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  create_bd_addr_seg -range 0x00200000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
